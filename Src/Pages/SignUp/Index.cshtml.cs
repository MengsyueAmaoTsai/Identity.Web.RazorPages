    ...
    IdentityViewModel
{
    ...
    public async Task<IActionResult> OnPostAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            ModelState.AddModelError("Email", "Someone already has this email address. Try another name or claim one of these that's available");
            return Page();
        }
    ...
    private IActionResult CreatePassword() => RedirectToPage(
